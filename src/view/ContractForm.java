...
public class ContractForm extends javax.swing.JInternalFrame {
        ...
        try {
            ...
            for (Account acc : accounts) {
                tblModel.addRow(new Object[]{
                    stt++, acc.getUsername(), acc.getName(), FormatterDisplay.formatPhoneNumber(acc.getPhone()), acc.getRole()
                });
            }
        } catch (Exception e) {
    ...
    private void btnUpdateMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnUpdateMouseClicked
        ...
        try {
            ...
            accountSelected = AccountManager.getInstance().getAccounts().get(rowSelected);
            if (accountSelected.equals(AccountManager.getInstance().getCurrentAccount())) {
    ...
    private void btnRemoveMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnRemoveMouseClicked
        ...
        try {
            ...
            if (choice == JOptionPane.YES_OPTION) {
                AccountManager.getInstance().removeAccount(rowSelected);
